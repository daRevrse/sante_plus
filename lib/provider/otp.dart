      ...
      body: Column(
        ...
        children: [
          Container(
            ...
            child: Center(
              child: Text(
                'Vérification par code du +228 ${widget.phone}',
...
class RegisterOTP extends StatefulWidget {
  ...
  RegisterOTP(this.phone,this.userModel);
  @override
              ...
              onSubmit: (pin) async {
                try {
                  await FirebaseAuth.instance
                      ...
                      .then((value) async {
                    if (value.user != null) {
                      createUser(userModel: widget.userModel,uid: value.user!.uid);
                      Navigator.pushAndRemoveUntil(
                          context,
                          MaterialPageRoute(builder: (context) => Home(widget.userModel)),
                              (route) => false);
                    }
                  });
                } catch (e) {
...
Future createUser({required UserModel userModel,required String uid}) async {
...
Future<UserModel?> readUser(String uid,UserModel? _userModel) async {
